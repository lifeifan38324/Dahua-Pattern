...
#include "14_observer_delegate_pattern/Boss.h"
#include "14_observer_delegate_pattern/Secretary.h"
#include "14_observer_delegate_pattern/StockObserver.h"
#include "14_observer_delegate_pattern/NBAObserver.h"
using namespace std;
